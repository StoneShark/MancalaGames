...
STRING_DICTS = {
    ...
    'CaptExtraPick': lookup_dicts(
        ...
        {'No additional': gi.CaptExtraPick.NONE,
         ...
         "Pick all Opponent's via Basic": gi.CaptExtraPick.PICKOPPBASIC,
    ...
    'SowLapCont': lookup_dicts(
        ...
        {'No Additional Reason': gi.SowLapCont.NONE,
         ...
         'Not when end in a store': gi.SowLapCont.STOP_STORE,
         'Not from stores': gi.SowLapCont.NOT_FROM_STORE,
         }),
